...
def cadastrar_cliente():                    #   Função para cadastrar novo cliente;
    ...
    if nome and cpf:
        ...
        VALUES(DEFAULT, '{nome}', '{cpf}', DEFAULT)
        ''')
        conn.commit()
...
#   Função para visualizar Cliente específico ao remover, também mostra os alugueis do Cliente escolhido;
