...
def menu_clientes():
    ...
    window = sg.Window('Farmácia XYZ - Menu Clientes', layout, size=(400, 250))
...
def cadastrar_cliente():
    layout = [
        [sg.Text('- Cadastro de Cliente -')],
        [sg.Text('Nome: *'), sg.Input(key='nome')],
        [sg.Text('CPF (somente números): *'), sg.Input(key='cpf')],
    ...
    window = sg.Window('Farmácia XYZ - Cadastro de Cliente', layout)
    ...
    while True:
        ...
        if event == 'Cadastrar':
            ...
            if len(cpf) == 11 and cpf.isnumeric():
                ...
                sg.Popup(f"O cliente {nome} foi cadastrado com sucesso.", title="Cadastro de Cliente")
                break
            else:
                sg.Popup('''
CPF inválido! 
...
def main():
    ...
    while True:
        layout = [
            ...
            [sg.Button(emoji.emojize(':busts_in_silhouette: Menu Clientes'), size=(20, 2), button_color=('black', '#4e8cff'), key='clientes')], 
            [sg.Button(emoji.emojize(':package: Menu Produtos'), size=(20, 2), button_color=('black', '#4e8cff'), key='produtos')], 
            [sg.Button(emoji.emojize(':shopping_cart: Menu Compras'), size=(20, 2), button_color=('black', '#4e8cff'), key='compras')],
            [sg.Button('Sair', size=(10, 2), button_color=('black', '#e74c3c'))],
        ]
        
        window = sg.Window('Farmácia XYZ', layout, size=(800, 250))
